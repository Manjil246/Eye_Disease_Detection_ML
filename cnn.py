...
convnet = conv_2d(convnet, 32, 3, activation='relu')#add convlutional layers
convnet = max_pool_2d(convnet, 3)#Doing max pooling for input

convnet = conv_2d(convnet, 64, 3, activation='relu')#relu-non linear activation function
